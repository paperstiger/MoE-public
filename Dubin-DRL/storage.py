...
class RolloutStorage(object):
    ...
    def feed_forward_generator(self, advantages, num_mini_batch):
        ...
        assert batch_size >= num_mini_batch, (
            "PPO requires the number processes ({}) ".format(num_processes) +
            "* number of steps = {} ".format(num_processes * num_steps) +
             "to be greater than or equal to the number of PPO mini batches ({}).".format(num_mini_batch))
